...
ALL_TARGETS = $(SPMV_TACO) $(SPGEMM_TACO) 
# $(SPMV_EIGEN) $(SPGEMM_EIGEN) $(GRAPHBLAS) $(LAGRAPH) graphs/rmat_gen $(BFS_LAGRAPH) $(BELLMAN_FORD_LAGRAPH)
...
$(TACO): $(TACO_CLONE)
	...
	mkdir -p build ;\
	cd build ;\
	cmake -DPYTHON=false -DCMAKE_BUILD_TYPE=Release -DOPENMP=OFF .. ;\
