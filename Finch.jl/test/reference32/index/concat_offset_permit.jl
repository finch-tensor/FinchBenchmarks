begin
    ...
    phase_stop_2 = min(C_lvl_stop, 10, A_lvl_stop)
    if phase_stop_2 >= 1
        A_lvl_q = A_lvl_ptr[1]
    ...
    phase_stop_8 = min(C_lvl_stop, 0, 10 + B_lvl_stop)
    if phase_stop_8 >= 11
        B_lvl_q = B_lvl_ptr[1]
    ...
    phase_stop_13 = min(C_lvl_stop, A_lvl_stop, 10 + B_lvl_stop)
    if phase_stop_13 >= 11
        A_lvl_q = A_lvl_ptr[1]
        A_lvl_q_stop = A_lvl_ptr[1 + 1]
        if A_lvl_q < A_lvl_q_stop
    ...
    phase_start_19 = max(11, 1 + A_lvl_stop)
    phase_stop_21 = min(C_lvl_stop, 10 + B_lvl_stop)
    ...
    phase_start_25 = max(1, 11 + B_lvl_stop)
    phase_stop_27 = min(C_lvl_stop, A_lvl_stop)
